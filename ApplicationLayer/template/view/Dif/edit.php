        ...
        <!-- Main row -->
          ...
          <form role="form" action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        <label>Tel No</label>
                        <input type="tel" class="form-control" name="phone" value="<?=$row['phone']?>" style="width: auto" placeholder="XXX-XXXXXXX" pattern="[0-9]{3}-[0-9]{7}" required>
                      </div>
                  </div>
                  <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                  ...
                  <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        <label>Class</label>
                        <select class="form-control" name="class" style="width: auto" required>
                            <option name="class" ><?=$row['class']?></option>
                            <option value="1 ILTIZAM">1 ILTIZAM</option>
                            <option value="1 IHSAN">1 IHSAN</option>
                            <option value="3 IHSAN">3 IHSAN</option>
                            <option value="3 ILTIZAM">3 ILTIZAM</option>
                          </select>
                      </div><br>
                  </div>
                </div>
                <div class="col-md-6">
                  ...
                  <div class="form-group" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      ...
                      <input type="text" id="photoImage" value="<?=$row['image'] ?>" size="10" readonly>
              ...
              <div class="row">
                <div class="col-md-5">
                  <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        <label>Name</label>
                        <input type="text" class="form-control" name="eName" value="<?=$row['eName']?>" style="width: 100%" placeholder="Name" required>
                      </div>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        ...
                        <input type="text" class="form-control" name="eRel" value="<?=$row['eRel']?>" style="width: 70%" placeholder="Relationship" required> *Eg: Mother/Father/Brother/Aunt
                      </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        <label>Tel No</label>
                       <input type="tel" class="form-control" name="ePhone" value="<?=$row['ePhone']?>" style="width: 40%" placeholder="XXX-XXXXXXX" pattern="[0-9]{3}-[0-9]{7}" required>
                      </div>
                  </div>
                </div>
            ...
            <div class="card-footer">
              <input type="hidden" name="data" value="<?=$row['ic']?>+<?=$row['image']?>"><button type="submit" class="btn btn-primary" name="update"><i class="icon fas fa-check"></i>&nbsp;Update</button>
