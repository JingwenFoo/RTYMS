...
$data = $order->runnerViewOrders($orderID); //main data
$link = $order->runnerViewOrders($orderID); //site link

$runner = new registerController();
$datas = $runner->viewRunner();

if(isset($_POST['update'])){
    $order->editRunnerOrder();
}
?>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info"><?php
            foreach($datas as $row1){
                ?>
          <a href="#" class="d-block"><?=$row1['runnerName']?></a><?php }?>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="runnerMain.php" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Delivery Status Update</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
          ...
          <form role="form" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><i class="nav-icon fas fa-user"></i> Delivery Details</h3>
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="row">
                  <div class="col-md-4">
                    <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        ...
                        <input type="text" class="form-control" name="spName" value="<?=$row['spName']?>" style="width: auto" readonly>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                  ...
                  <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        ...
                        <input type="text" class="form-control" name="spAddress" value="<?=$row['spAddress']?>" style="width: 80%" readonly>
                      </div>
                  </div>
                ...
                <div class="col-md-4">
                    <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        ...
                        <input type="text" class="form-control" name="customerPhone" value="<?=$row['customerPhone']?>" style="width: auto" readonly>
                      </div>
                    </div> 
                  </div>
                  <div class="col-md-4">
                ...
                <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        ...
                        <input type="text" class="form-control" name="customerAddress" value="<?=$row['customerAddress']?>" style="width: 80%" readonly>
                      </div>
                      <br><input type="hidden" name="orderID" value="<?=$row['orderID']?>">
            ...
            <div class="card-footer">
              <button type="button" onclick="location.href='runnerMain.php'" class="btn btn-success"><i class="fas "></i><<&nbsp;Back </button>&nbsp;&nbsp;
              <input type="hidden" name="data" value="<?=$row['orderID']?>+<?=$row['itemID']?>"><button type="submit" class="btn btn-primary" name="update"><i class="icon fas fa-check"></i>&nbsp;DELIVERED TO CUSTOMER</button>
            </div>
            </div>
          </form>
        </div><?php } ?>
