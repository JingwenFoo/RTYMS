        ...
        <!-- Main row -->
          ...
          <form role="form" action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        <label>Name</label>
                        <input type="text" class="form-control" name="runnerName" value="<?=$row['runnerName']?>" style="width: 80%" required>
                      </div>
                  </div>
                <div class="row">
                  <div class="col-md-4">
                    <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        ...
                        <input type="text" class="form-control" name="runnerUsername" value="<?=$row['runnerUsername']?>" style="width: auto" required>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        ...
                        <input type="text" class="form-control" name="runnerPassword" value="<?=$row['runnerPassword']?>" style="width: auto" required>
                      </div>
                    </div>
                  </div>
                </div> 
                ...
                <div class="col-md-4">
                    <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        ...
                        <input type="text" class="form-control" name="vehicleType" value="<?=$row['vehicleType']?>" style="width: auto" required>
                      </div>
                    </div>
                  </div>
                <div class="col-md-4">
                    <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        ...
                        <input type="text" class="form-control" name="vehiclePlate" value="<?=$row['vehiclePlate']?>" style="width: auto" required>
                      </div>
                    </div>
                  </div>
                </div>
                 ...
                 <div class="col-md-12">
                  <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="runnerPhone" value="<?=$row['runnerPhone']?>" style="width: auto" required>
                      </div>
            ...
            <div class="card-footer">
              <button type="button" onclick="location.href='runnerViewProfile.php'" class="btn btn-success"><i class="fas fa-times"></i>&nbsp;Cancel </button>&nbsp;&nbsp;
              <input type="hidden" name="data" value="<?=$row['runnerID']?>"><button type="submit" class="btn btn-primary" name="update"><i class="icon fas fa-check"></i>&nbsp;Update</button>
