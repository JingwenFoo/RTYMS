    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info"><?php
            foreach($data as $row){
                ?>
          <a href="#" class="d-block"><?=$row['runnerName']?></a>
        </div>
      </div>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="runnerViewProfile.php?">View profile</a></li> 
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <!-- Main row -->
          ...
          <form role="form" action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        <label>Name</label>
                        <input type="text" class="form-control" name="runnerName" value="<?=$row['runnerName']?>" style="width: 80%" readonly>
                      </div>
                  </div>
                <div class="row">
                  <div class="col-md-4">
                    <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        ...
                        <input type="text" class="form-control" name="runnerUsername" value="<?=$row['runnerUsername']?>" style="width: auto" readonly>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        ...
                        <input type="text" class="form-control" name="runnerPassword" value="<?=$row['runnerPassword']?>" style="width: auto" readonly>
                      </div>
                    </div>
                  </div>
                </div> 
                ...
                <div class="col-md-4">
                    <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        ...
                        <input type="text" class="form-control" name="vehicleType" value="<?=$row['vehicleType']?>" style="width: auto" readonly>
                      </div>
                    </div>
                  </div>
                <div class="col-md-4">
                    <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        ...
                        <input type="text" class="form-control" name="vehiclePlate" value="<?=$row['vehiclePlate']?>" style="width: auto" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                 ...
                 <div class="col-md-12">
                  <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="runnerPhone" value="<?=$row['runnerPhone']?>" style="width: auto" readonly>
                      </div>
                  </div><br><input type="hidden" name="runnerID" value="<?=$row['runnerID']?>">
                </div>
              </div>
            ...
            <div class="card-footer">
              ...
              <button type="button" onclick="location.href='runnerEditProfile.php?runnerID=<?=$row['runnerID']?>'" class="btn btn-primary">&nbsp; Update details</button>&nbsp;&nbsp;
            </div>
