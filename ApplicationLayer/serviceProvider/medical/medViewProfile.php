        ...
        <!-- Main row -->
          ...
          <form role="form" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-footer">
              <button type="button" onclick="location.href='medSPMain.php'" class="btn btn-success"><i class="fas "></i><<&nbsp;Back </button>&nbsp;&nbsp;
              <button type="button" onclick="location.href='medEditProfile.php?servProvID=<?=$row['servProvID']?>'" class="btn btn-primary">&nbsp; Update details</button>&nbsp;&nbsp;
            </div>
