...
$data = $order->viewAllMedOrder();
$ordered = $order->viewallMedOrdered();
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <form action="" method="POST">                    
                    <button type="button" onclick="location.href='medEditOrder.php?orderID=<?=$row['orderID']?>'" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></button>&nbsp;&nbsp;
                </form></td>
