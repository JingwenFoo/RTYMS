...
$data = $order->viewAllGoodOrder();
$ordered = $order->viewAllGoodOrdered();
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="goodAddItem.php" class="nav-link" title>
          ...
          <li class="nav-item">
            <a href="goodViewProfile.php" class="nav-link " title>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th style="width: 13%">Order Created</th>
                ...
                <form action="" method="POST">                    
                    <button type="button" onclick="location.href='goodEditOrder.php?orderID=<?=$row['orderID']?>'" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></button>&nbsp;&nbsp;
                </form></td>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th style="width: ">Order Quantity</th>
                  <th style="width: ">Total Price (RM)</th>
                  <th style="width: ">Order Created</th>
                  <th style="width: ">Order Status</th>
                  <th style="width: ">Customer Name</th>
                  <th style="width: ">Customer Address</th>
                </tr>
                </thead>
                <tbody>
                <?php
                $i=1;
                foreach($ordered as $row1){

                  echo"<tr>";
                  echo"<td>" .$i. "</td>";
                  echo"<td>" .$row1['orderID']."</td>";
                  echo"<td>" .$row1['orderItemQty']."</td>";
                  echo"<td>" .$row1['orderTotalPrice']."</td>";
                  echo"<td>" .$row1['orderTime']."</td>";
                  echo"<td>" .$row1['orderStatus']."</td>";
                  echo"<td>" .$row1['customerName']."</td>";
                  echo"<td>" .$row1['customerAddress']."</td>";
