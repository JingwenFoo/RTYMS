      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info"><?php
            foreach($datas as $row){
                ?>
          <a href="#" class="d-block"><?=$row['spName']?></a><?php } ?>
        </div>
      </div>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="goodViewOrder.php">View order</a></li> <?php foreach ($link as $rowz) {?>
