...
$goodSP = new registerController();
$data = $goodSP->viewGoodSP();
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="goodSPMain.php" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="goodSPMain.php" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="goodSPMain.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="goodAddItem.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="goodViewOrder.php" class="nav-link">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="goodSPMain.php">Home</a></li> 
              <li class="breadcrumb-item"><a href="goodViewProfile.php?">View profile</a></li> 
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <!-- Main row -->
          ...
          <form role="form" action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        ...
                        <input type="text" class="form-control" name="spName" value="<?=$row['spName']?>" style="width: 80%" readonly>
                      </div>
                  </div>
                <div class="row">
                  <div class="col-md-4">
                    <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        ...
                        <input type="text" class="form-control" name="spUsername" value="<?=$row['spUsername']?>" style="width: auto" readonly>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        ...
                        <input type="text" class="form-control" name="spPassword" value="<?=$row['spPassword']?>" style="width: auto" readonly>
                      </div>
                    </div>
                  </div>
                </div> 
                ...
                <div class="col-md-4">
                    <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        <label>Email</label>
                        <input type="text" class="form-control" name="spEmail" value="<?=$row['spEmail']?>" style="width: auto" readonly>
                      </div>
                    </div>
                  </div>
                <div class="col-md-4">
                    <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        <label>Phone</label>
                        <input type="text" class="form-control" name="spPhone" value="<?=$row['spPhone']?>" style="width: auto" readonly>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="">
                        ...
                        <input type="text" class="form-control" name="ssm" value="<?=$row['ssm']?>" style="width: auto" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            ...
                            <div class="input-group-append">
                              ...
                              <button type="button" name="button" onclick="document.getElementById('uploadFile').click()" style="display:none"  class="input-group-text">Upload Image</button>
                 ...
                 <div class="col-md-12">
                  <div class="" style="padding: 0.5rem!important;flex: 1 1 auto !important;">
                      <div class="form-group">
                        ...
                        <textarea id="description" name="spAddress" class="form-control" style="height:220px;width: 100%; resize: none" readonly> <?php echo $row['spAddress']?></textarea>
                      </div>
            ...
            <div class="card-footer">
              <button type="button" onclick="location.href='goodSPMain.php'" class="btn btn-success"><i class="fas "></i><<&nbsp;Back </button>&nbsp;&nbsp;
              <button type="button" onclick="location.href='goodEditProfile.php?servProvID=<?=$row['servProvID']?>'" class="btn btn-primary">&nbsp; Update details</button>&nbsp;&nbsp;
            </div>
