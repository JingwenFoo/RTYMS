        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="goodSPMain.php">Item</a></li>
        ...
        <!-- Main row -->
          ...
          <form role="form" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-footer">
              <button type="button" onclick="location.href='goodSPMain.php'" class="btn btn-success"><i class="fas fa-times"></i>&nbsp;Cancel </button>&nbsp;&nbsp;
