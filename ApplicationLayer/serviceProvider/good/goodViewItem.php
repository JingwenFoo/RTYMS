<?php
require_once $_SERVER["DOCUMENT_ROOT"].'/RTYMS/BusinessServicesLayer/controller/goodController.php';
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="goodViewItem.php?itemID=<?=$_GET['itemID']?>"><?=$con['itemName']?></a></li>
              <?php } ?>         
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
        ...
        <!-- Main row -->
          ...
          <form role="form" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-footer">
              <button type="button" onclick="location.href='goodSPMain.php'" class="btn btn-success"><i class="fas fa-chevron-left"></i>&nbsp;Back</button>&nbsp;&nbsp;
              <button type="button" onclick="location.href='goodEditItem.php?itemID=<?=$row['itemID']?>'" class="btn btn-primary"><i class="fas fa-check"></i>&nbsp; Update details</button>&nbsp;&nbsp;
            </div>
