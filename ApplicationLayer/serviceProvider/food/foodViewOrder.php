...
$data = $order->viewAllFoodOrder();
$ordered = $order->viewAllFoodOrdered();
           ...
           <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <form action="" method="POST">                    
                    <button type="button" onclick="location.href='foodEditOrder.php?orderID=<?=$row['orderID']?>'" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></button>&nbsp;&nbsp;
                </form></td>
