...
$foodSP = new registerController();
$data = $foodSP->viewFoodSP();
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="foodAddItem.php" class="nav-link">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="foodViewProfile.php?">View profile</a></li> 
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <!-- Main row -->
          ...
          <form role="form" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-footer">
              <button type="button" onclick="location.href='foodSPMain.php'" class="btn btn-success"><i class="fas "></i><<&nbsp;Back </button>&nbsp;&nbsp;
              <button type="button" onclick="location.href='foodEditProfile.php?servProvID=<?=$row['servProvID']?>'" class="btn btn-primary">&nbsp; Update details</button>&nbsp;&nbsp;
            </div>
