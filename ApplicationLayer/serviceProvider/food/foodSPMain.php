<?php
require_once $_SERVER["DOCUMENT_ROOT"].'/RTYMS/BusinessServicesLayer/controller/foodController.php';      //execute function item
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="foodSPMain.php " class="nav-link active">
      ...
      <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="foodAddItem.php" class="small-box-footer">Add here! <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="foodViewOrder.php" class="small-box-footer">Manage here! <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="foodViewProfile.php" class="small-box-footer">View profile! <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <form action="" method="POST">
                    <button type="button" onclick="location.href='foodViewItem.php?itemID=<?=$row['itemID']?>'" class="btn btn-success"><i class="fas fa-info-circle"></i></button>&nbsp;&nbsp;
                    
                    <button type="button" onclick="location.href='foodEditItem.php?itemID=<?=$row['itemID']?>'" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></button>&nbsp;&nbsp;
