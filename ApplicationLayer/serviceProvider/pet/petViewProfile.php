...
$petSP = new registerController();
$data = $petSP->viewPetSP();
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="petSPMain.php" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="petSPMain.php" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="petSPMain.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="petAddItem.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="petViewOrder.php" class="nav-link">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="petSPMain.php">Home</a></li> 
              <li class="breadcrumb-item"><a href="petViewProfile.php?">View profile</a></li> 
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <!-- Main row -->
          ...
          <form role="form" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-footer">
              <button type="button" onclick="location.href='petSPMain.php'" class="btn btn-success"><i class="fas "></i><<&nbsp;Back </button>&nbsp;&nbsp;
              <button type="button" onclick="location.href='petEditProfile.php?servProvID=<?=$row['servProvID']?>'" class="btn btn-primary">&nbsp; Update details</button>&nbsp;&nbsp;
            </div>
