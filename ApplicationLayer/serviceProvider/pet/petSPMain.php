<?php
require_once $_SERVER["DOCUMENT_ROOT"].'/RTYMS/BusinessServicesLayer/controller/petController.php';      //execute function item
...
$item = new petController();
$data = $item->viewAll();
$name = new registerController();
$datas = $name->viewPetSP();
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="petSPMain.php " class="nav-link active">
      ...
      <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="petAddItem.php" class="small-box-footer">Add here! <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h4>Manage Order<sup style="font-size: 20px"></sup></h4>
              ...
              <a href="petViewOrder.php" class="small-box-footer">Manage here! <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="petViewProfile.php" class="small-box-footer">View profile! <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <form action="" method="POST">
                    <button type="button" onclick="location.href='petViewItem.php?itemID=<?=$row['itemID']?>'" class="btn btn-success"><i class="fas fa-info-circle"></i></button>&nbsp;&nbsp;
                    
                    <button type="button" onclick="location.href='petEditItem.php?itemID=<?=$row['itemID']?>'" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></button>&nbsp;&nbsp;

                    <input type="hidden" name="itemID" value="<?=$row['itemID']?>"><button name="delete" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete?')"><i class="fas fa-trash"></i></button>
                  </form></td>
