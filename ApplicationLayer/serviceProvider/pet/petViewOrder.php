...
$data = $order->viewAllPetOrder();
$ordered = $order->viewAllPetOrdered();
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="petAddItem.php" class="nav-link" title>
          ...
          <li class="nav-item">
            <a href="petViewProfile.php" class="nav-link " title>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <form action="" method="POST">                    
                    <button type="button" onclick="location.href='petEditOrder.php?orderID=<?=$row['orderID']?>'" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></button>&nbsp;&nbsp;
                </form></td>
