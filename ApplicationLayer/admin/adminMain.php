    ...
    <section class="content">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">New Register Service Provider</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                foreach($data as $row){
                  ...
                  echo"<tr>";
                  echo"<td>" .$i. "</td>";
                  echo"<td>" .$row['servProvID']."</td>";
                  echo"<td>" .$row['spName']."</td>";
                  echo"<td>" .$row['spType']."</td>";
                ...
                <form action="" method="POST">                    
                    <input type="hidden" name="data" value="<?=$row['servProvID']?>"><button type="submit" class="btn btn-primary" name="approve"><i class="icon fas fa-check"></i>&nbsp;Approve</button>

                    <input type="hidden" name="servProvID" value="<?=$row['servProvID']?>"><button name="delete" class="btn btn-danger" onClick="return confirm('Are you sure you want to reject?')"><i class="fas fa-trash"></i></button>
                  </form></td>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Active Service Provider</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                foreach($datas as $rows){
                  ...
                  echo"<tr>";
                  echo"<td>" .$i. "</td>";
                  echo"<td>" .$rows['servProvID']."</td>";
                  echo"<td>" .$rows['spName']."</td>";
                  echo"<td>" .$rows['spType']."</td>";
                  echo"<td>" .$rows['spPhone']."</td>";
                  echo"<td>" .$rows['spEmail']."</td>";
                  echo"<td>" .$rows['spAddress']."</td>";
                  echo"<td>" .$rows['ssm']."</td>";                 
                ?>
