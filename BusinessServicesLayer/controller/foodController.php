...
class foodController{
    ...
    function addItem(){
		...
		echo "<script type='text/javascript'>alert('$message');
		      window.location = '../../../ApplicationLayer/serviceProvider/food/foodSPMain.php'; 
                </script>";
        }
    }

    //view all item based on food
    function viewAll(){
        $item = new itemModel();
        return $item->viewallFoodItem();
    }
    ...
    function viewItemDetail($itemID){
        $item = new itemModel();
        $item->itemID = $itemID;
        return $item->viewItemDetail($itemID);
    }
    ...
    function editItem(){
		...
		echo "<script type='text/javascript'>alert('$message');
		window.location = '../../../ApplicationLayer/serviceProvider/food/foodViewItem.php?itemID=".$_POST['itemID']."';</script>";
    ...
    function deleteItem(){
		...
		echo "<script type='text/javascript'>alert('$message');
		window.location = ''../../../ApplicationLayer/serviceProvider/food/foodSPMain.php?';</script>";    //?servProvID=".$_POST['servProvID']."
        }
    }
}
?>
