...
class goodController{
    ...
    function addItem(){
		...
		echo "<script type='text/javascript'>alert('$message');
		      window.location = '../../../ApplicationLayer/serviceProvider/good/goodSPMain.php'; 
                </script>"; 
        }
    }

    //view all item based on good
    function viewAll(){
        $item = new itemModel();
        return $item->viewallGoodItem();
    }
    ...
    function editItem(){
		...
		echo "<script type='text/javascript'>alert('$message');
		window.location = '../../../ApplicationLayer/serviceProvider/good/goodViewItem.php?itemID=".$_POST['itemID']."';</script>";
    ...
    function deleteItem(){
		...
		echo "<script type='text/javascript'>alert('$message');
		window.location = ''../../../ApplicationLayer/serviceProvider/good/goodSPMain.php?';</script>";    //?servProvID=".$_POST['servProvID']."
        }
    }
}
?>
