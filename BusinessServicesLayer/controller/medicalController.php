...
class medicalController{
    ...
    function addItem(){
		...
		echo "<script type='text/javascript'>alert('$message');
		      window.location = '../../../ApplicationLayer/serviceProvider/medical/medSPMain.php'; 
                </script>"; 
        }
    }

    //view all item based on medical
    function viewAll(){
        $item = new itemModel();
        return $item->viewallMedItem();
    }
    ...
    function editItem(){
		...
		echo "<script type='text/javascript'>alert('$message');
		window.location = '../../../ApplicationLayer/serviceProvider/medical/medViewItem.php?itemID=".$_POST['itemID']."';</script>";
    ...
    function deleteItem(){
		...
		echo "<script type='text/javascript'>alert('$message');
		window.location = ''../../../ApplicationLayer/serviceProvider/medical/medSPMain.php?';</script>";    //?servProvID=".$_POST['servProvID']."
        }
    }
}
?>
